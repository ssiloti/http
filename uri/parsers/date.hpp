...
typedef boost::fusion::tuple<
    ...
    //std::string,
    // day. month, year
    boost::fusion::tuple<unsigned, boost::gregorian::date::month_type, unsigned>,
    // hour, minute, second
    boost::fusion::tuple<unsigned, unsigned, unsigned>
    > date_tuple_type;

static const char month_lookup[12][3] = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};

struct month_parser : boost::spirit::qi::symbols<char, boost::gregorian::date::month_type>
{
    month_parser()
    {
...
struct date_grammar : boost::spirit::qi::grammar<Interator, date_grammar>
{
    ...
    boost::spirit::qi::rule<Iterator, boost::fusion::tuple<unsigned, boost::gregorian::date::month_type, unsigned>()> date1;
