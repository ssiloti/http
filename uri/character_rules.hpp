...
#ifndef URI_CHARACTER_RULES
#define URI_CHARACTER_RULES
...
class character_rules : public abnf::core_rules<Iterator>
{
public:
    ...
    character_rules()
    {
        ...
        unreserved %= alpha | digit | qi::char_("-._~");

        // pct-encoded = "%" HEXDIG HEXDIG
        pct_encoded %= qi::char_("%") >> qi::repeat(2)[hexdig];
